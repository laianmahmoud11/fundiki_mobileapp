...
export function DataProvider({
  ...
  const [pastBookings, setPastBookings] =
    useState<Booking[]>([]);
  ...
  const addSavedHotel = useCallback(
  ...
  const removeSavedHotel = useCallback(
    async (hotelId: string) => {
      ...
      try {
        ...
        Alert.alert(
          'Success',
          'Hotel removed from saved!'
        );

      } catch (error) {

        console.error(
          'Error removing hotel:',
          error
        );
